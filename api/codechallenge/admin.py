...
from .models import Event, Question, Submission, WinningSubmission, Answer, Category, Author
...
class EventResource(admin.ModelAdmin):
    list_display = ["id", "title", "start_time", "end_time", "media_field", "description"]

@admin.register(Question)
class QuestionResource(admin.ModelAdmin):
    list_display = ("id","event","title","body", "description", "format", "difficulty", "expiration_time", "max_attempts" ,"get_categories", "get_authors", "modify_time")
